...
(function($, document, window, undefined) {
  ...
  defaults: {
    ...
    templates: {
      buttons: function() {
        var options = this.options;
        return '<div class="wizard-buttons">' +
          '<a class="btn btn-medium btn-rounded btn-transparent-default-gray " href="#' + this.id + '" data-wizard="back" role="button">' + options.buttonLabels.back + '</a>' +
          '<a class="btn btn-medium  btn-main btn-rounded btn-transparent-main float-right" href="#' + this.id + '" data-wizard="next" role="button">' + options.buttonLabels.next + '</a>' +
          '<a class="btn btn-medium  btn-rounded  btn-success  float-right btn-finish" href="#' + this.id + '" data-wizard="finish" role="button">' + options.buttonLabels.finish + '</a>' +
          '</div>';
      }
    }
  }
  ...
  (function() {
    ...
    $("#clientFormContainer, #contractorFormContainer, #consultantFormContainer, #supplierFormContainer ,#addTenderForm, #cmp-key, #cmp-plaster , #dmh-wizard" ).wizard(options);
  })();
